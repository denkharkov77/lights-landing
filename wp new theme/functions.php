...
/*add_action( 'wp_enqueue_scripts', 'rsol_scripts' );

function rsol_scripts()
{
	wp_enqueue_style( '1', get_template_directory_uri() . 'assets/css/style.css', array(), THEME_VERSION );
	//wp_enqueue_style( '2', get_template_directory_uri() . '/css/global-style.css', array(), THEME_VERSION );
}
*/
/*
